...
export function useSfxEngine() {
  ...
  const soundConfig = useMemo(() => ({
    ...
    'tech-discovery': { frequency: 780, duration: 0.2, type: 'triangle' as OscillatorType },
    ...
    'city-conquest': { frequency: 240, duration: 0.22, type: 'sawtooth' as OscillatorType },
    'city-conversion': { frequency: 420, duration: 0.18, type: 'sine' as OscillatorType },
    'construction-complete': { frequency: 520, duration: 0.12, type: 'triangle' as OscillatorType },
    'unit-ready': { frequency: 560, duration: 0.12, type: 'square' as OscillatorType },
    'unit-veteran': { frequency: 640, duration: 0.16, type: 'triangle' as OscillatorType },
