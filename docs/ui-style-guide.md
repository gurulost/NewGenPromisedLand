# Chronicles of the Promised Land - UI Style Guide
...
* **4K:** `@screen 2xl` → `p-10`, `text-xl`, icon `w-5`.
...
* **Manual playtest matrix:** keyboard‑only, game‑pad, 4K monitor, 13″ laptop, iPad portrait.
...
- [x] WorldElementPanel - Complete AAA implementation with all features
- [ ] Core primitives extraction (PanelShell, PanelHeader, etc.)
- [ ] PlayerHUD rewrite with HUDShell
- [ ] CityPanel modernization with Radix Tabs
- [ ] CombatPanel with virtualization
- [ ] TechPanel full rebuild with gestures
