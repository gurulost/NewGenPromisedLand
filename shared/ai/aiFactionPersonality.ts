...
const FACTION_PERSONALITIES: Record<string, Partial<FactionPersonality>> = {
  nephites: {
    ...
    buildingPriorities: ['temple', 'school', 'market', 'barracks'],
    techPriorities: ['writing', 'priesthood', 'metallurgy', 'navigation'],
    unitPreferences: ['spearman', 'archer', 'missionary'],
  ...
  lamanites: {
    ...
    buildingPriorities: ['barracks', 'forge', 'walls', 'temple'],
    techPriorities: ['bronze_working', 'warrior_code', 'hunting', 'shamanism'],
    unitPreferences: ['warrior', 'scout', 'berserker'],
  ...
  mulekites: {
    ...
    buildingPriorities: ['market', 'harbor', 'granary', 'temple'],
    techPriorities: ['sailing', 'currency', 'pottery', 'writing'],
    unitPreferences: ['trader', 'scout', 'archer'],
  ...
  'anti-nephi-lehies': {
    ...
    diplomacy: 0.9,
    preferredVictory: 'faith',
    buildingPriorities: ['temple', 'school', 'granary', 'market'],
    techPriorities: ['priesthood', 'pacifism', 'agriculture', 'meditation'],
    unitPreferences: ['missionary', 'worker', 'healer'],
  ...
  zoramites: {
    ...
    buildingPriorities: ['market', 'library', 'temple', 'walls'],
    techPriorities: ['philosophy', 'rhetoric', 'currency', 'engineering'],
    unitPreferences: ['elite_warrior', 'scholar', 'spy'],
  ...
  jaredites: {
    ...
    diplomacy: 0.1,
    preferredVictory: 'conquest',
    buildingPriorities: ['barracks', 'monument', 'forge', 'walls'],
    techPriorities: ['bronze_working', 'masonry', 'warfare', 'beast_mastery'],
    unitPreferences: ['heavy_warrior', 'siege_engine', 'beast_rider'],
