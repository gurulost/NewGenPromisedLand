...
export const WORLD_ELEMENTS: Record<string, WorldElement> = {
  ...
  ore_vein: {
    ...
    uiTooltipHarvest: 'Tap for 2★ and 1 Pop (raises Pride & Dissent)',
    uiTooltipBuild: 'Spend 5★ for Mine (+1 Pop, +1★/turn, +1 Faith)',
    notes: 'Replaces metal resource - mountain-based population boost'
  },
